...
file1="P18257_125.bias.GoodCov.tsv"
file2="P18257_126.bias.GoodCov.tsv"
file3="P18257_127.bias.GoodCov.tsv"
...
writeLines(as.character(bae$gene), "R05_91d_BAE.lst")

# Allele-specific expression
ase <- noNAs[noNAs$mean > 20 & noNAs$mean <= 60,]
print(paste0("ASE: ", nrow(ase)))
writeLines(as.character(ase$gene), "R05_91d_ASE.lst")

# Monoallelic expression
mae <- noNAs[noNAs$mean > 60,]
print(paste0("MAE: ", nrow(mae)))
writeLines(as.character(mae$gene), "R05_91d_MAE.lst")
