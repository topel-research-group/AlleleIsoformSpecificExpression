...
finalout = "ALC_None_Ss_T1_results.tsv"
...
with open(finalout, "w") as outfile:
	for chrom in variantpos:
		for pos in variantpos[chrom]:
			...
			alldepths = [int(depth1), int(depth2), int(depth3), int(depth4)]
			allgenos = [geno1, geno2, geno3, geno4]
			...
			elif (geno1 == geno2) and (geno3 == geno4) and (geno1 != geno3):
				thislocus = []
