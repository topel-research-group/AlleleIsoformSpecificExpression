...
group1 = "../../Groups/None_" + timepoint + "/None_" + timepoint + "_filtered.vcf.gz"
group2 = "../../Groups/Copepods_" + timepoint + "/Copepods_" + timepoint + "_filtered.vcf.gz"

# Define outfile for the whole analysis
finalout = timepoint + "_w_wo_copepods_results.tsv"
